...
export declare const Knict: {
    ...
    Knict: typeof KnictM.Knict;
    path: typeof KnictM.path;
    get: typeof KnictM.get;
    SendIpc: typeof KnictM.SendIpc;
    addon: typeof KnictM.addon;
    str: typeof KnictM.str;
    number: typeof KnictM.number;
